import {
  ...
  const secondaryFeatures = [
    {
      name: 'Online All the Time.',
      description: 'Hyper responsive, probably online rn.',
      icon: CloudArrowUpIcon,
    },
    {
      name: 'High-Trust.',
      description: 'One time we airdropped 1.5M by hand.',
      icon: LockClosedIcon,
    },
    {
      name: 'Simple.',
      description: 'We are not here to muck about. Solutions, fast.',
      icon: ArrowPathIcon,
    },
    {
      name: 'Undoxxed.',
      description: 'We value privacy. Be who you want to be.',
      icon: FingerPrintIcon,
    },
    {
      name: 'Grindcore Workmaxxed.',
      description: 'Literally addicted to building.',
      icon: Cog6ToothIcon,
    },
    {
      name: 'Cloud Capable.',
      description: 'Yeah some of our shit is on the cloud. ',
      icon: ServerIcon,
    },
  ]
  const stats = [
    { id: 1, name: 'Total Franchise MC', value: '$800,000+' },
    { id: 2, name: 'Years in ETH', value: '24' },
    { id: 3, name: 'Milady', value: '999x' },
    { id: 4, name: 'Posts', value: '8k+' },
  ]
        ...
        <main>
            ...
            <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-40 lg:flex lg:px-8 lg:pt-40">
              <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                ...
                <div className="mt-24 sm:mt-32 lg:mt-16">
                  <a href="#" className="inline-flex space-x-6">
                    ...
                    <span className="inline-flex items-center space-x-2 text-sm font-medium leading-6 text-gray-300">
                      <span>Shipping StationThisBot rn</span>
                      <ChevronRightIcon className="h-5 w-5 text-gray-500" aria-hidden="true" />
                    </span>
                  </a>
                </div>
                <h1 className="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">
                  Try to keep up, nothing can stop this
                </h1>
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  <a
                    href="https://twitter.com/miladystation"
                    className="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
                  >
                    Follow the Journey
                  </a>
                  {/* <a href="https://t.me/MONYGROUPPORTAL" className="text-sm font-semibold leading-6 text-white">
                    Join the Alpha chat <span aria-hidden="true">→</span>
                  </a> */}
                </div>
              </div>
          ...
          <div className="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
            <h2 className="text-center text-lg font-semibold leading-8 text-white">
              The world’s most innovative companies were outworked by us
            </h2>
          ...
          <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-base font-semibold leading-7 text-indigo-400">Get Built</h2>
          ...
          <div className="mt-32 sm:mt-56">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl sm:text-center">
                <h2 className="text-base font-semibold leading-7 text-indigo-400">OG Milady</h2>
                <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">In case you didn’t realize, we’ve been here for a little while.</p>
                <p className="mt-6 text-lg leading-8 text-gray-300">
