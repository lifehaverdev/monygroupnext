...
export const metadata = { title: "Security Auditing" };
      ...
      <section className="scroll-snap-section relative flex flex-col items-center justify-center min-h-screen w-full overflow-hidden">
        ...
        <GlassCard className="relative z-10 text-center flex flex-col items-center gap-6 max-w-2xl mx-auto px-8 py-12 rounded-2xl" id="hero">
          ...
          <p className="text-neutral-600 dark:text-neutral-300 text-base sm:text-lg leading-relaxed">
            Manual review, formal verification, and comprehensive analysis. Security research for immutable code.
          </p>
      ...
      <section className="scroll-snap-section flex flex-col items-center justify-center min-h-screen w-full py-16">
        <ScrollReveal {...scrollRevealConfig.about}>
          <GlassCard className="max-w-3xl mx-auto px-8 py-8 rounded-xl text-center" id="about">
            ...
            <p className="mb-2">
              Independent security auditing focused on finding vulnerabilities before deployment. Manual review, formal verification, and tool-assisted analysis for smart contracts.
            </p>
          </GlassCard>
        </ScrollReveal>
      </section>
        ...
        {[
          {
            ...
            desc: "Line-by-line analysis of contract logic, edge cases, and architectural risks",
          },
          {
            title: "Formal Verification",
            desc: "Mathematical proof of contract correctness and safety properties",
          },
          {
            title: "Tool-Assisted Analysis",
            desc: "Foundry, Slither, fuzzing, and symbolic execution for comprehensive coverage",
          },
          {
            title: "Gas Optimization",
            desc: "Efficiency analysis and recommendations for cost-effective execution",
          },
          {
            title: "Report & Recommendations",
            desc: "Detailed findings with annotations, severity ratings, and remediation guidance",
          },
        ].map((service, idx) => (
      ...
      <section className="scroll-snap-section flex flex-col items-center justify-center min-h-screen w-full py-16">
        <ScrollReveal {...scrollRevealConfig.contact}>
          <GlassCard className="max-w-3xl mx-auto px-8 py-8 text-center rounded-xl" id="contact">
            ...
            <p className="mb-4">Ready to audit your contracts? Let's ensure they're secure before deployment.</p>
